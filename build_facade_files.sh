...
mod_name="$mod_prefix/grpc-gateway-facade/go"
...
do
    ...
    echo "Generating spec for $proto_file"
    protoc --proto_path=$proto_dir --openapiv2_out=../ --openapiv2_opt=allow_merge=true $openapi_args $proto_file
done
